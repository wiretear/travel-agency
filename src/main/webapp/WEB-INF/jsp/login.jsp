...
<spring:url value="/images/" var="image" />
...
<form:form class="form-signin"  modelAttribute="oUsers" name="login_form" action="/show" method="post"  id="login_form">
    ...
    <form:input  path="password" type="password" id="inputPassword" class="form-control" placeholder="Password"  required="required"/>
        ...
        <a href="registration" class="forgot-password">
